...
public class ActivityServiceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_activity_service, container, false);
    ...
    private void getData()
    {
        ...
        String url = "http://tkjbpnup.com/kelompok_5/acku/ambil_pesanan/getServiceTakeOrder/" + id_user;;
